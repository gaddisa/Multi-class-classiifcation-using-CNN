"""
This part is only for the implementation without augumentation
it only consists of three transformation:
    image resizing, Linear Interpolation and Normalizion of image intensity
    
    The preprocssing with the data augumentation can be found in 
    data_prepro.py 
"""

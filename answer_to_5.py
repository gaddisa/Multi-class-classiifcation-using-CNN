...
###################################################################################################
    ...
    This code contains answer to question 5 regularized CNN
    On top of the first question I added few lines of code to the cost function to make it regularized
    I collect the regularization  of conv layer and fully connected layer and then sum up to add into
    the cross entropy loss. I sel alpha to 0.0005
